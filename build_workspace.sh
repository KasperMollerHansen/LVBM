...
IGNORE_PACKAGES="isaac_common isaac_common_py isaac_ros_apriltag_interfaces isaac_ros_bi3d_interfaces isaac_ros_common isaac_ros_launch_utils isaac_ros_nitros_bridge_interfaces isaac_ros_nova_interfaces isaac_ros_pointcloud_interfaces isaac_ros_r2b_galileo isaac_ros_rosbag_utils isaac_ros_tensor_list_interfaces isaac_ros_test isaac_ros_test_cmake"
